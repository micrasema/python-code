...
#and output the number of observations within each cluster.
...
KMeans_out = cluster.vq.kmeans2(array, k = number_of_ks, iter = 100, minit = 'points')
...
pl.title("Distribution of rates")
pl.xlabel("rates")
pl.ylabel("Frequency")
pl.show()